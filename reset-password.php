    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
        <div class="form-group">
            ...
            <input type="password" class="form-control <?php echo (!empty($new_password_err)) ? 'is-invalid' : ''; ?>"
                   name="new_password" id="new-password" aria-describedby="helpId" value="<?php echo $new_password; ?>">
        ...
        <div class="form-group mt-2">
            ...
            <input type="password"
                   ...
                   name="confirm_password" id="confirm-password" aria-describedby="helpId">
